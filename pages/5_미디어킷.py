...
with tab_pedia:
    ...
    products_pedia = [
        {
            "name": "1. 전면 팝업 배너",
            "desc": "앱, 웹 진입 시 팝업 형태로 노출. 높은 유저 주목도와 클릭 효과.",
        ...
        {
            "name": "2. 웹 배너",
            "desc": "홈 화면 및 왓챠피디아 세상 페이지에 위치. 이미지/동영상 소재 가능, 클릭 유도에 효과적.",
            "location": "홈 화면 / 왓챠피디아 세상 페이지",
            "slots": "총 2구좌, 1주일 50% 랜덤 노출",
            "device": "APP + WEB",
            "price": "500만원/주",
            "impressions": "약 150만",
        ...
        {
            "name": "3. 밀어 배너",
            "desc": "홈 밀어넣기 1지면에 노출. 3초 뒤 다른 구좌로 전환되는 주목도 높은 상품.",
            "location": "메인 홈 화면 밀어넣기 1지면",
            "slots": "총 2구좌, 1주일 50% 랜덤 노출",
            "device": "APP + WEB",
            "price": "500만원/주",
            "impressions": "약 70만",
        ...
        {
            "name": "4. 드로어 배너",
            "desc": "앱, 웹 총 6개 지면 내 First View에 노출. 우수한 노출량과 클릭 유도.",
            "location": "홈 / 왓챠피디아 세상 / 검색 / 나의 왓챠 등 6개 지면",
            "slots": "총 2구좌, 1주일 50% 랜덤 노출",
            "device": "APP + WEB",
            "price": "1,000만원/주",
            "impressions": "약 500만",
